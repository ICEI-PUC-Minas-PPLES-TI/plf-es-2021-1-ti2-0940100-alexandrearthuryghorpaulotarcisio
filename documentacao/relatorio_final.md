...
| Ociosidade de automóveis | Verificar os modelos de automóveis que tem baixa preferência para serem alugados para posteriormente não serem adquiridos em renovação de frotas | Mede a relação entre meses de atividade do automóvel e a quantidade de alugueis realizados | MA = Meses de Atividade do Automóvel; QAR = Quantidade de alugueis realizados; R = Relação entre meses de atividade do automóvel e a quantidade de alugueis realizados. Cálculo: R = (MA / QAR) | Tabela Automóvel | Processos internos |
| Indicador de lucratividade | Verificar a lucratividade mensal da empresa | Mede o índice de lucratividade pela relação entre o lucro líquido e a receita dos alugueis| L = Lucro líquido; R = Receita dos alugueis; IL = Índice de Lucratividade Cálculo: IL = (L / R) * 100 | Tabela Aluguel | Empresa
